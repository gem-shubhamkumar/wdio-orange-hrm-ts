...
import { addStepLog } from './utils/actionUtils';
...
export const config: Options.Testrunner = {
    ...
    suites: {
        ...
        regression: [
            ...
            './features/**/TC11*.feature',
            './features/**/TC15*.feature',
            './features/**/TC21*.feature',
        ],
    },
    ...
    // },
    beforeScenario: async function ({ gherkinDocument, pickle }, context) {
        const file = JSON.stringify(pickle)
        // addStepLog("[SCENARIO]".padEnd(12) + JSON.parse(file).name)
    ...
    // },
    beforeStep: function (step, scenario, context) {
        // addStepLog("[STEP]".padStart(8).padEnd(12) + step.text)
    },
    /**
     *
